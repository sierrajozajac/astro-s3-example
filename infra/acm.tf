...
# One validation record per name on the cert.
...
# Blocks the apply until ACM has actually issued the cert. Usually under two
# minutes; the first run can take longer.
